...
public class AutorService {
	...
	public void atualizar(Autor autor) {
		if(autor.getId() == null) {
			throw new IllegalArgumentException("Para atualizar, é necessário que o autor já esteja salvo!");
		}
		validator.validar(autor);
	...
	public void deletar(Autor autor) {
		if(possuiLivro(autor)) {
			throw new OperacaoNaoPermitidaException("Não permitido excluir um Autor que possui livros cadastrados.");
		}
